...
function roundResult(input){
    ...
    switch(val1){
        case "A":
            if(val2 == "X") return scoreCard.X + scoreCard.draw;
            if(val2 == "Y") return scoreCard.Y + scoreCard.win;
            if(val2 == "Z") return scoreCard.Z + scoreCard.lost;
            break;
        case "B":
            ...
            break;
        case "C":
            if(val2 == "X") return scoreCard.X + scoreCard.win;
            if(val2 == "Y") return scoreCard.Y + scoreCard.lost;
            if(val2 == "Z") return scoreCard.Z + scoreCard.draw;
            break;
